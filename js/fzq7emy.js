...
window.Typekit.config = {
    ...
    "dl": "AAAALAAAAApxGUmGAAAD0w==",
    "f": "//use.typekit.net/c/85ee9e/1w;museo-sans,1,Py6:N:n3,PyF:N:n7,PyH:N:n9/{format}{/extras*}?3bb2a6e53c9684ffdc9a9aff1d5b2a62de246c40fc2071e052ac61e425c9beb0ddd1582489ac2dc1fbdeba7bc49a4bf42c2f0fdb4907029cd8e73117e0a93d71258df748d448d462e5e3e1eaeea3252c4efc343aa4e1e09817a2f820ac3f80e2b3",
    "fi": [2005, 2009, 2011],
    "fn": ["museo-sans", ["n3", "n7", "n9"]],
    "ht": "tk",
    "js": "1.6.5",
    "k": "//use.typekit.net/{id}.js",
    "kt": "fzq7emy",
    "l": "typekit",
    "p": "//p.typekit.net/p.gif?s=1&k=fzq7emy&ht=tk&h={host}&f=2005.2009.2011&a=923804&_={_}",
    "ps": 1,
    "w": "fzq7emy"
};
/*{"k":"1.6.5","auto_updating":false}*/
...
(function(window, document, undefined) {
    ...
    la.prototype.parse = function() {
        ...
        if (-1 != this.e.indexOf("MSIE") || -1 != this.e.indexOf("Trident/")) {
            ...
            var b = D(this),
                ...
                f = k,
                g = k,
                h = E(this.e, /Trident\/([\d\w\.]+)/, 1),
                p = F(this.R),
                d = -1 != this.e.indexOf("MSIE") ? E(this.e, /MSIE ([\d\w\.]+)/, 1) : E(this.e, /rv:([\d\w\.]+)/, 1),
                e = y(d);
            ...
            a = new A("MSIE", e, d, f, g, h, a, c, b, p, new u("Windows" == a && 6 <= e.g || "Windows Phone" == a && 8 <= c.g, l, l))
                ...
                E(this.e, /Presto\/([\d\w\.]+)/, 1), c = y(b), d = D(this), e = y(d), f = F(this.R), c.g !== k ? a = "Presto" : (-1 != this.e.indexOf("Gecko") && (a = "Gecko"), b = E(this.e, /rv:([^\)]+)/, 1), c = y(b)), -1 != this.e.indexOf("Opera Mini/")) g = E(this.e, /Opera Mini\/([\d\.]+)/, 1), h = y(g), a = new A("OperaMini", h, g, a, c, b, C(this), e, d, f, new u(l, l, l));
            else {
    ...
    O.prototype.h = function(a, b) {
        var c = b || {},
            d = this.Sa.replace(/\{\/?([^*}]*)(\*?)\}/g, function(a, b, d) {
